...
class Titlescreen(ptg.Menu):
    def __init__(self):
        ...
        ptg.Menu.__init__(self,(800,600),(0,200,200),header,buttons,"sports_card.wav")
        self.buttonlist += [pt.Button(0,'go to second screen',(300,450),True,self.image,
                                      func = lambda:2,sound = 'button_click.wav')]
...
class Screen_two(ptg.Menu):
    def __init__(self):
        ...
        self.buttonlist += [pt.Button(0,'go to first screen',(300,450),True,self.image,
                                      func = lambda:1,sound = 'button_click.wav')]
